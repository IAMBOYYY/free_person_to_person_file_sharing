...
//
// Layout (little-endian), 21 bytes, followed by `blockLen` payload bytes:
//   0  u8   magic 0xD1
//   1  u8   magic 0x0C
...
//  20  u8   flags       bit 0 = private (encrypted)
